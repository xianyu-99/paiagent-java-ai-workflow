...
export const AgentConfig: React.FC<NodeConfigProps> = ({ node, onSave, getReferenceableParams, registerDraftSaver }) => {
  ...
  const validateConfig = useCallback(() => {
    ...
    if (!llmConfig.systemPrompt) { message.warning('请填写 Agent 的系统提示词'); return false; }
    ...
    <Form layout="vertical" className="mt-4">
      ...
      <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-lg">
        ...
        <Form.Item label="挂载工具 (Tools)">
          <Select
            ...
            onChange={(val) => updateLlmConfig({...llmConfig, tools: val})}
      ...
      <Form.Item label="系统提示词 (System Prompt)" required>
        <Input.TextArea
          ...
          onChange={(e) => updateLlmConfig({...llmConfig, systemPrompt: e.target.value})}
