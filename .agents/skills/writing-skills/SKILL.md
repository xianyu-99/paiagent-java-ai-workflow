...
- Project-specific conventions (put in `.agents/AGENTS.md`)
...
```yaml
# ‚ù?BAD: Too abstract, vague, doesn't include when to use
description: For async testing

# ‚ù?BAD: First person
description: I can help you with async tests when they're flaky

# ‚ù?BAD: Mentions technology but skill isn't specific to it
description: Use when tests use setTimeout/sleep and are flaky

# ‚ú?GOOD: Starts with "Use when", describes problem, no workflow
description: Use when tests have race conditions, timing dependencies, or pass/fail inconsistently

# ‚ú?GOOD: Technology-specific skill with explicit trigger
...
- ‚ú?`using-skills` not `skill-usage`
- ‚ú?`flatten-with-flags` > `data-structure-refactoring`
...
- ‚ú?Good: `**REQUIRED SKILL:** Use .agents/skills/test-driven-development/SKILL.md`
- ‚ú?Good: `**REQUIRED BACKGROUND:** You MUST understand .agents/skills/systematic-debugging/SKILL.md`
- ‚ù?Bad: `See skills/testing/test-driven-development` (unclear if required)
- ‚ù?Bad: `@skills/testing/test-driven-development/SKILL.md` (force-loads, burns context)
...
- Testing techniques ‚Ü?TypeScript/JavaScript
- System debugging ‚Ü?Shell/Python
- Data processing ‚Ü?Python
